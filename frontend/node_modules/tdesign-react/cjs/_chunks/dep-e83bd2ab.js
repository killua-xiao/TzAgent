...
var _typeof = require('./dep-667ac7af.js');
...
var select_base_Option = require('../select/base/Option.js');
...
function setValueToOptionFormOptionDom(dom, valueToOption, keys) {
  ...
  valueToOption[value] = _objectSpread$1(_objectSpread$1({}, dom.props), {}, defineProperty._defineProperty(defineProperty._defineProperty({}, (keys === null || keys === void 0 ? void 0 : keys.value) || "value", value), (keys === null || keys === void 0 ? void 0 : keys.label) || "label", label || children || value));
}
var getValueToOption = function getValueToOption(children, options, keys) {
    ...
    options.forEach(function (option) {
      if (isSelectOptionGroup(option)) {
        ...
        (_option$children = option.children) === null || _option$children === void 0 || _option$children.forEach(function (child) {
          valueToOption[get.get(child, (keys === null || keys === void 0 ? void 0 : keys.value) || "value")] = _objectSpread$1(_objectSpread$1({}, child), {}, {
            value: get.get(child, (keys === null || keys === void 0 ? void 0 : keys.value) || "value"),
            label: get.get(child, (keys === null || keys === void 0 ? void 0 : keys.label) || "label")
          });
        });
      } else {
        valueToOption[get.get(option, (keys === null || keys === void 0 ? void 0 : keys.value) || "value")] = _objectSpread$1(_objectSpread$1({}, option), {}, {
          value: get.get(option, (keys === null || keys === void 0 ? void 0 : keys.value) || "value"),
          label: get.get(option, (keys === null || keys === void 0 ? void 0 : keys.label) || "label")
        });
      }
    });
  ...
  if (isPlainObject.isPlainObject(children)) {
    if (children.type === select_base_Option["default"]) {
  ...
  if (Array.isArray(children)) {
    var _handlerElement = function handlerElement(item) {
      if (item.type === select_base_Option["default"]) {
        setValueToOptionFormOptionDom(item, valueToOption, keys);
      }
...
var getLabel = function getLabel(children, value, options, keys) {
  ...
  if (Array.isArray(options)) {
    options.some(function (option) {
      if ([get.get(value, (keys === null || keys === void 0 ? void 0 : keys.value) || "value"), value].includes(option.value)) {
...
var getMultipleTags = function getMultipleTags(values, keys) {
  var tags = values.map(function (item) {
    return {
      label: get.get(item, (keys === null || keys === void 0 ? void 0 : keys.label) || "label") || item.toString(),
      value: get.get(item, (keys === null || keys === void 0 ? void 0 : keys.value) || "value") || item
    };
  });
  return tags;
};
      ...
      currentValues = currentValues.filter(function (item) {
        if (isValueObj) {
          if (isPlainObject.isPlainObject(activeValue)) {
            return get.get(item, (keys === null || keys === void 0 ? void 0 : keys.value) || "value") !== get.get(activeValue, (keys === null || keys === void 0 ? void 0 : keys.value) || "value");
          }
          return get.get(item, (keys === null || keys === void 0 ? void 0 : keys.value) || "value") !== activeValue;
        }
...
function UseOptions(keys, options, children, valueType, value, reserveKeyword) {
  ...
  React.useEffect(function () {
    ...
    var optionChildren = arrayChildren.filter(function (v) {
      return v.type === select_base_Option["default"] || v.type === select_base_OptionGroup["default"];
    });
...
//# sourceMappingURL=dep-e83bd2ab.js.map
