...
var largeNumber = require('../_chunks/dep-e75d22fc.js');
...
function useInputNumber(props) {
  ...
  var max = props.max,
    min = props.min,
    largeNumber$1 = props.largeNumber,
  ...
  React.useEffect(function () {
    ...
    if (!largeNumber$1 && !Number.isNaN(userInput)) {
    ...
    if (largeNumber$1) {
      ...
      if (decimalPlaces !== void 0 && largeNumber.largeNumberToFixed(inputValue, decimalPlaces, largeNumber$1) !== tValue) {
  ...
  }, [tValue, max, min, largeNumber$1, onValidate]);
  ...
  var onInnerInputChange = function onInnerInputChange(inputValue, _ref) {
    ...
    if (!canInputNumber(val, largeNumber$1)) return;
    setUserInput(val);
    if (largeNumber$1) {
      onChange(val, {
        type: "input",
