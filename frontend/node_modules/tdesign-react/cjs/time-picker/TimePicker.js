...
var customParseFormat = require('../_chunks/dep-1d328330.js');
...
var TimePicker = _util_forwardRefWithStatics["default"](function (originalProps, ref) {
  var props = hooks_useDefaultProps["default"](originalProps, timePicker_defaultProps.timePickerDefaultProps);
  ...
  var allowInput = props.allowInput,
    ...
    format = _props$format === void 0 ? timePicker_panel_SinglePanel.DEFAULT_FORMAT : _props$format,
    _props$hideDisabledTi = props.hideDisabledTime,
    hideDisabledTime = _props$hideDisabledTi === void 0 ? true : _props$hideDisabledTi,
    _props$steps = props.steps,
    steps = _props$steps === void 0 ? timePicker_panel_SinglePanel.DEFAULT_STEPS : _props$steps,
    ...
    onOpen = _props$onOpen === void 0 ? _util_noop["default"] : _props$onOpen,
    _props$onInput = props.onInput,
    onInput = _props$onInput === void 0 ? _util_noop["default"] : _props$onInput,
    _props$onPick = props.onPick,
    onPick = _props$onPick === void 0 ? _util_noop["default"] : _props$onPick,
  ...
  var handleInputBlur = function handleInputBlur(value2, ctx) {
    if (allowInput) {
      var isValidTime = timePicker_panel_SinglePanel.validateInputValue(currentValue, format);
      if (isValidTime) {
        onChange(timePicker_panel_SinglePanel.formatInputValue(currentValue, format));
      }
    }
  ...
  TimePickerPanel: timePicker_panel_TimePickerPanel["default"]
});
