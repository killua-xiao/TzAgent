...
var OptionGroup = function OptionGroup(props) {
  var _useDefaultProps = hooks_useDefaultProps["default"](props, select_defaultProps.optionGroupDefaultProps),
  ...
  return /* @__PURE__ */React__default["default"].createElement("li", {
    className: classNames__default["default"]("".concat(classPrefix, "-select-option-group"), defineProperty._defineProperty({}, "".concat(classPrefix, "-select-option-group__divider"), divider))
